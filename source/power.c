 ...
 */
			...
			if (j%SPWM_STEP%2 == 0) {
				if (i%SPWM_STEP < 8)
					...
					for (count=8*COUNT_DELAY; count; count--);
				GPIOPinWrite(GPIO_PORTF_BASE, GPIO_PIN_0 | GPIO_PIN_1, GPIO_PIN_0);
			}
		}
		/* Delay */

...
#define DAC_2_PERIPH	SYSCTL_PERIPH_GPIOB
#define DAC_2_PORT	GPIO_PORTB_BASE
#define DAC_PERIPH	SYSCTL_PERIPH_GPIOD
#define DAC_PORT	GPIO_PORTD_BASE

#define DAC_DIN		GPIO_PIN_4
#define DAC_CLK		GPIO_PIN_5
#define DAC_CS		GPIO_PIN_5
#define DAC_PORT_MASK	(DAC_CLK | DAC_DIN)
#define DAC_2_MASK	(DAC_CS)
...
#define DAC_CS_H	GPIOPinWrite(DAC_2_PORT, DAC_CS, 0xff)
#define DAC_CS_L	GPIOPinWrite(DAC_2_PORT, DAC_CS, 0x00)

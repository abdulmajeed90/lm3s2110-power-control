...
#define SHUNT_VOLTAGE			0x03
#define BUS_VOLTAGE				0x04
 ...
 */
#define INA_CAL				40960
#define Own_Adress			0x01
#define BusVolOffset		0x34		// in mV 
#define INA_CONF			(BUS_VOL_RAN_16|PGA_GAIN_40|BADC_128_SAMPLE|SADC_128_SAMPLE|MODE_SHUNT_BUS_CON) 
